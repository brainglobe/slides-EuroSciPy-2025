...
## Example data { background-color="black" }
![](img/whole.png){.nostretch fig-align="center" width=65%}

## Example data { background-color="black" }
![](img/crop.png){.nostretch fig-align="center" width=65%}

## Whole-brain registration
### [`brainreg`](https://github.com/brainglobe/brainreg)

![](img/brainreg_filtering.png){.nostretch fig-align="center" width="100%"}
...
![](img/brainreg_2.gif){.nostretch fig-align="center" width="75%"}
